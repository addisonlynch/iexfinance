...
def IexFinance(symbol, **kwargs):
    ...
    Keyword arguments:
        ...
        options: A valid list of parameters to pass to the api. See _IEXBase base class, where these parameters are checked
...
class Share(_IEXBase):
    """
    Class to handle individual shares. Inherits _IEXBase, which will conduct the API queries
    """
    ...
    def __init__(self, symbol, **kwargs):
        ...
        Keyword arguments:
            options: Again a pass through to the _IEXBase class, which will be supered here. Options checked in the parent class.
        """
...
class Batch(_IEXBase):
    """
    Class to handle multiple shares. Inherits _IEXBase, which will conduct the API queries.
    """
